...
public class IPerfProperties
{
	...
	public static final double DEFAULT_TCP_BUFFER_LENGTH = 56;
	
	public static final String KEY_TCP_BUFFER_LENGTH_UNIT = "tcp-buffer-length-unit";
	public static final IperfUnit DEFAULT_TCP_BUFFER_LENGTH_UNIT = IperfUnit.KBYTES;
	...
	public static final double DEFAULT_TCP_WINDOW_SIZE = 64;
	...
	public static final double DEFAULT_TCP_MSS = 1400;
	
	public static final String KEY_TCP_MSS_UNIT = "tcp-mss-unit";
	public static final IperfUnit DEFAULT_TCP_MSS_UNIT = IperfUnit.BYTES;
	...
	public static final double DEFAULT_UDP_BUFFER_SIZE = 64;
	...
	public static final double DEFAULT_UDP_PACKET_SIZE = 1400;
